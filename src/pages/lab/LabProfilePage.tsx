...
import { LogOut, Settings, ChevronRight, Mail, Phone, FlaskConical } from 'lucide-react'
...
export function LabProfilePage() {
  ...
  return (
    <AppShell role="laboratory" title="Profile" subtitle="Laboratory account">
      <div className="space-y-5 animate-fade-in">
        <Card className="text-center">
          ...
          <div className="flex justify-center gap-2 mt-3">
            <Badge variant="secondary" dot>Laboratory</Badge>
          </div>
        </Card>
        ...
        <Card>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-neutral-700">Laboratory Technician</span>
            </div>
          </div>
        </Card>

        <div className="space-y-2">
          <button onClick={() => navigate('/lab/settings')} className="w-full flex items-center justify-between p-4 bg-white rounded-2xl border border-neutral-100 shadow-card hover:shadow-soft-lg transition-all">
            <div className="flex items-center gap-3">
